...
var _dayEventsJs = require("./landingPage/dayEvents.js");
var _weekEventsJs = require("./landingPage/weekEvents.js");
...
_dayEventsJs.render(_dayEventsJs.generateVideoMarkup(_dataJs.theaterData.events));
_dayEventsJs.render(_dayEventsJs.generateInfoMarkup(_dataJs.theaterData.events));
// Render the second section: events of the week
window.addEventListener('load', ()=>{
    _weekEventsJs.generateImgBkg(_dataJs.theaterData.events);
    _weekEventsJs.render(_weekEventsJs.generateInfoMarkup(_dataJs.theaterData.events));
});
_weekEventsJs.displayEventHandler(_dataJs.theaterData.events);
...
_outstandingNewsJs.filterNews(_dataJs.theaterData.news).slice(0, 4).reverse().forEach((singleNews)=>_outstandingNewsJs.render(_outstandingNewsJs.generateNewsMarkup(singleNews))
);
// Render the all News Page
_outstandingNewsJs.filterNews(_dataJs.theaterData.news).forEach((singleNews)=>_newsJs.render(_newsJs.generateAllNews(singleNews))
);
_newsJs.showContent();
//Render Calendar
...
},{"./data.js":"lKWCw","./headerFooter.js":"5sETY","./landingPage/dayEvents.js":"dtLSx","./landingPage/weekEvents.js":"5SaKU","./landingPage/subsModal.js":"5YiyO","./event.js":"e9rOw","./news.js":"4Hozf","./landingPage/outstandingNews.js":"a4xEc","./allevents.js":"5NFPk","./landingPage/scroll-up.js":"5xJk9","./landingPage/calendar.js":"1FA6L"}],"lKWCw":[function(require,module,exports) {
...
},{"./helpers/bundle-url":"chiK4"}],"dtLSx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5SaKU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
